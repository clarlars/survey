...
import static org.opendatakit.survey.espresso.TestConstants.APP_INIT_TIMEOUT;
import static org.opendatakit.survey.espresso.TestConstants.APP_START_TIMEOUT;
import static org.opendatakit.survey.espresso.TestConstants.OBJ_WAIT_TIMEOUT;
import static org.opendatakit.survey.espresso.TestConstants.SURVEY_PKG_NAME;
...
public class UIUtils {
  public static boolean turnOnCustomHome(UiDevice mDevice) {
    ...
    try {
      startApp(mDevice, SURVEY_PKG_NAME);
